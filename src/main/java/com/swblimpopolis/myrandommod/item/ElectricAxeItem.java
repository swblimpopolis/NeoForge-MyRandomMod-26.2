...
// Battery-powered diamond axe. Extends AxeItem so it keeps log-stripping / copper-scraping, and reuses
// the shared charge logic from ElectricToolItem. Stripping is blocked while empty, like mining/attacking.
public class ElectricAxeItem extends AxeItem implements ElectricTool {
    public ElectricAxeItem(Properties properties) {
        super(ElectricToolItem.MATERIAL, 5.0F, -3.0F, properties);
    }
    ...
    public InteractionResult useOn(UseOnContext context) {
        // A dead axe strips nothing (mirrors "empty = does nothing").
